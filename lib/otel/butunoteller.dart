...
class OtelListeleme2 extends StatefulWidget {
  @override
  _OtelListeleme2State createState() => _OtelListeleme2State();
}

class _OtelListeleme2State extends State<OtelListeleme2> {
  @override
